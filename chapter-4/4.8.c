...
/* process I/O stream (in this version --
 * no more than 1 byte is returned to stream) */
int getch(void);
void ungetch(int c);
...
char io_cp;		/* stored byte */
char is_cp = 0;		/* is something stored (copied) */
